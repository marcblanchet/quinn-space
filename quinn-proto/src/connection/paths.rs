...
impl RecoveryMetrics {
    ...
    fn to_qlog_event(&self, previous: &Self) -> Option<MetricsUpdated> {
        ...
        Some(MetricsUpdated {
            ...
            smoothed_rtt: updated.smoothed_rtt.map(|rtt| rtt.as_micros() as f32 / 1000.0),
            latest_rtt: updated.latest_rtt.map(|rtt| rtt.as_micros() as f32 / 1000.0),
            rtt_variance: updated.rtt_variance.map(|rtt| rtt.as_micros() as f32 / 1000.0),
            pto_count: updated
                .pto_count
